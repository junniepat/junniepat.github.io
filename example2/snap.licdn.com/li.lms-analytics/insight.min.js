...
PixelLogger=function(d){function a(){return a.__super__.constructor.apply(this,arguments)}__extends(a,d);a.https_path="../px.ads.linkedin.com/insight_tag_errors.gif";a.log=function(b,c){var e,f;e=this.map_error_data(c,"&",encodeURIComponent);f=new Image(1,1);f.src=""+this.https_path+"?"+e;return f};return a}(BaseLogger);
