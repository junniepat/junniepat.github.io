const apiURL = 'https://api.openweathermap.org/data/2.5/weather?id=4720583&units=imperial&appid=db10eaf58a4d0a2fae9355c262a4613e';
fetch(apiURL)
...
const URL = 'https://api.openweathermap.org/data/2.5/forecast?id=4720583&units=imperial&appid=db10eaf58a4d0a2fae9355c262a4613e';
fetch(URL)
  .then((response) => response.json())
  .then((res) => {
